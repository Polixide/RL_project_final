...
class CustomWandbLogger(BaseCallback):
    ...
    def _on_step(self) -> bool:
        ...
        if done and "episode_result" in info:
            ...
            log_data[f"episode_type/{episode_result}"] = 1

            
            log_data["episode_result"] = episode_result
...
if __name__ == '__main__':
    ...
    CHECKPOINT_DIR = "checkpoint_dir/PPO_2M_UDR"
    MODEL_DIR = "model_dir/PPO_2M_UDR"
    ...
    try:
        ...
        model = PPO('MlpPolicy', envs, verbose=1, device='cuda', tensorboard_log="./tb_logs/",n_steps=2048,batch_size=512,n_epochs=10)
        ...
        # Final model
        model.save(os.path.join(MODEL_DIR, "PPO_2M_UDR.mdl"))
